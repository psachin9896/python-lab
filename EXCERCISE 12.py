...
class EquilateralTriangle(Triangle):
    ...
    def findPerimeter(self ):
        return self.sides[1] * 3

    def __add__(self):
        result = perimeter_2 + perimeter_3
        return result
...
if __name__ == "__main__":
    ...
    perimeter_3 = E1.findPerimeter()
    print("the perimeter of the equilateral_triangle is {}".format(perimeter_2))
    result = E1.__add__()
    print("the sum of the perimeters is {}".format(result))
